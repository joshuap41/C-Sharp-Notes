...
namespace OveridingMethods
{
    class Program
    {
        //to override a method, set the method in the object class to "virtual" and then set the child class method to "override". This snippit is from BringingItAllTogether Project.
